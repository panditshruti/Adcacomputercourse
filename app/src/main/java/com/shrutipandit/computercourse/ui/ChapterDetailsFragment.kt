...
class ChapterDetailsFragment : Fragment(R.layout.fragment_chapter_details) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentChapterDetailsBinding.bind(view)
        ...
        binding.listview.setOnItemClickListener { _, _, position,_  ->
            ...
            val action = ChapterDetailsFragmentDirections.actionChapterDetailsFragmentToChapterNotesDetailsFragment("ch$chNo")
